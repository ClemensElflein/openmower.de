...
the latest version]({{% relref "/docs/knowledge-base/firmware-update" %}}) anyway.
{{% /alert %}}
...
For this, follow the [Manual Firmware Installation]({{% relref "/docs/knowledge-base/manual-firmware-installation/" %}}) guide.
